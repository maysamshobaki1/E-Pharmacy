...
if(isset($_POST['addabout']))
{
	...
	move_uploaded_file($temp_name1,"upload/about/$image1");
	move_uploaded_file($temp_name1,"upload/about/$image2");
	
	$sql="insert into about (title,content,image,title2,content2,image2) values('$title','$content','$image1','$title2','$content2','$image2')";
								...
								<div class="card-body">
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Title2</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="title2" required="">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Image2</label>
													<div class="col-lg-9">
														<input class="form-control" name="image2" type="file" required="">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Content2</label>
													<div class="col-lg-9">
														<textarea class="form-control" name="content2" rows="10" cols="30"></textarea>
													</div>
												</div>
											</div>
										</div>
